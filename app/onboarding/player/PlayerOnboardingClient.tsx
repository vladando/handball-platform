...
export default function PlayerOnboardingClient({ player }: { player: any }) {
  ...
  function skip() { setError(""); setCareerMsg(""); setMedMsg(""); setVideoMsg(""); setStep(s => s + 1); }
  ...
  function SkipBtn() {
    return (
      <div style={{ textAlign: "center", marginTop: 10 }}>
        <button onClick={skip} style={{ background: "none", border: "none", color: "var(--muted)", fontSize: "0.82rem", cursor: "pointer" }}>
          Skip this step &rarr;
        </button>
      </div>
    );
        ...
        {step === 0 && (
          <div style={{ ...card, textAlign: "center", padding: "44px 32px" }}>
            ...
            <div style={{ marginTop: 14 }}>
              <button onClick={() => router.push("/dashboard/player")} style={{ background: "none", border: "none", color: "var(--muted)", fontSize: "0.78rem", cursor: "pointer" }}>
