    ...
    <main className="page">
      <div className="sidebar-layout">
        <aside className="sidebar">
          <div style={{ padding:"0 24px 20px", borderBottom:"1px solid var(--border)", marginBottom:8 }}>
            ...
            <div style={{ marginTop:8 }}>
              {player.isAvailable ? <span className="badge badge-green">● Available</span> : <span className="badge badge-muted">● Unavailable</span>}
            </div>
          </div>
        ...
        <div className="main-content">
          <PlayerDashboardClient player={player as any} revealCount={revealCount} />
        </div>
      </div>
    </main>
  );
