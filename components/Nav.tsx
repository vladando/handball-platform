      ...
      <div className="nav-inner">
        ...
        <ul className="nav-links">
          ...
          {(role === "CLUB" || role === "PLAYER") && (
            <li><Link href="/messages" className={path.startsWith("/messages") ? "active" : ""}>Messages</Link></li>
          )}
        ...
        <div className="nav-actions">
          {session ? (
            <>
              ...
              <button onClick={() => signOut({ callbackUrl: "/" })} className="btn btn-outline" style={{ fontSize: "0.8rem", padding: "8px 16px" }}>
                Sign Out
              </button>
            </>
          ) : (
