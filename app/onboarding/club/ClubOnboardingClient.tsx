...
export default function ClubOnboardingClient({ club }: { club: any }) {
  ...
  function validateAndNext() {
    if (step === 1 && (!form.country.trim() || !form.city.trim() || !form.address.trim())) {
      setError("Country, city and address are required."); return;
    }
      ...
      <div style={{ width: "100%", maxWidth: 560 }}>
        ...
        {step === 1 && (
          <div style={card}>
            ...
            <div className="form-group">
              <label className="label">Club Address <span style={{ color: "var(--accent)" }}>*</span></label>
