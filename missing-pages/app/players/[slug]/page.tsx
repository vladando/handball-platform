        ...
        <div className="container" style={{ paddingTop:48, paddingBottom:48, position:"relative", zIndex:1 }}>
          <div style={{ display:"grid", gridTemplateColumns:"auto 1fr auto", gap:32, alignItems:"center" }}>
            ...
            <div>
              ...
              <h1 style={{ fontSize:"clamp(2rem,5vw,3.5rem)", lineHeight:1, marginBottom:8 }}>
          ...
          <div style={{ display:"flex", flexDirection:"column", gap:20 }}>
            ...
            {player.expectedSalary && (
              <div className="card">
                ...
                <div style={{ fontFamily:"var(--font-display)", fontWeight:900, fontSize:"2rem", color:"var(--accent)" }}>
                  €{Math.round(player.expectedSalary/100).toLocaleString()}
                </div>
            ...
            <div className="card">
              ...
              {[
                { k:"Height", v:`${player.heightCm} cm` },
                { k:"Weight", v:`${player.weightKg} kg` },
                { k:"Dominant Hand", v:player.dominantHand },
                { k:"Date of Birth", v:new Date(player.dateOfBirth).toLocaleDateString() },
              ].map(row => (
