    ...
    <main className="page" style={{ display:"flex", alignItems:"center", justifyContent:"center", minHeight:"100vh" }}>
      <div style={{ width:"100%", maxWidth:420, padding:"0 24px" }}>
        <div style={{ textAlign:"center", marginBottom:40 }}>
          ...
          {params.get("registered") && <div style={{ marginTop:12, padding:"10px 14px", background:"rgba(0,200,100,0.1)", border:"1px solid rgba(0,200,100,0.3)", borderRadius:"var(--radius)", fontSize:"0.85rem", color:"#00c864" }}>Account created! Sign in below.</div>}
        </div>
        <div className="card">
          <form onSubmit={handleSubmit}>
            ...
            {error && <div style={{ background:"rgba(255,59,59,0.1)", border:"1px solid rgba(255,59,59,0.3)", borderRadius:"var(--radius)", padding:"10px 14px", fontSize:"0.85rem", color:"var(--red)", marginBottom:16 }}>{error}</div>}
